(() => {
  ...
  function hydrateAudioSettings() {
    const storedSfx = Number(localStorage.getItem("gogo-awawa-sfx-volume"));
    const storedMusic = Number(localStorage.getItem("gogo-awawa-music-volume"));
